...
1. Download and install the latest release of Python 3.10 from python.org. I used [Python 3.10.13](https://www.python.org/downloads/release/python-31013/) directly from python.org.
